...
const Location = () => {
    ...
    return (
        <section className="mainContainerLocation">
            <form className="containerLocation" method="POST" onSubmit={handleSubmit}>
                <div className="pt-3">
                ...
                {error ? (
                    <p className="alert alert-danger text-center" role="alert">
                        Los Campos país, departamento, municipio, comuna, barrio, Tipo, número, indicativo, son
                        obligatorios
                    </p>
                ) : null}
                ...
                <div className="innerContainerLocation">
                    <div className="d-md-flex justify-content-between">
                        <div className="col-md-2">
                            <label htmlFor="country" className="form-label">
                                País <span style={{ color: "red", fontWeight: "bolder" }}>*</span>
                            </label>
                            <select
                                id="country"
                            ...
                            >
                                ...
                                <option key="venezuela" value="Venezuela">
                                    Venezuela
                                </option>
                                <option key="costarica" value="Costa Rica">
                                    Costa Rica
                                </option>
                                <option key="panama" value="Panamá">
                                    Panamá
                                </option>
                                <option key="brasil" value="Brasíl">
                                    Brasil
                                </option>
                                <option key="ecuador" value="Ecuador">
                                    Ecuador
                                </option>
                            </select>
                        </div>
                        ...
                        <div className="col-md-2 mt-4 mt-md-0">
                            <label htmlFor="state" className="form-label">
                                Departamento <span style={{ color: "red", fontWeight: "bolder" }}>*</span>
                            </label>
                            <select
                                id="state"
                                className="w-100 form-select"
                        ...
                        <div className="col-md-2 mt-4 mt-md-0">
                            <label htmlFor="city" className="form-label">
                                Municipio <span style={{ color: "red", fontWeight: "bolder" }}>*</span>
                            </label>
                            <select
                                id="city"
                                className="w-100 form-select"
                        ...
                        <div className="col-md-2 mt-4 mt-md-0">
                            <label htmlFor="comuna" className="form-label">
                                Comuna <span style={{ color: "red", fontWeight: "bolder" }}>*</span>
                            </label>
                            <select
                                id="comuna"
                                className="w-100 form-select"
                        ...
                        <div className="col-md-2 mt-4 mt-md-0">
                            <label htmlFor="barrio" className="form-label">
                                Barrio <span style={{ color: "red", fontWeight: "bolder" }}>*</span>
                            </label>
                            <select
                                id="barrio"
                                className="w-100 form-select"
                    ...
                    <div className="mt-5">
                        ...
                        <div className="d-md-flex justify-content-between mt-1">
                            <div className="col-md-2 mt-4 mt-md-0 pe-sm-0">
                                <label htmlFor="type1" className="form-label">
                                    Tipo <span style={{ color: "red", fontWeight: "bolder" }}>*</span>
                                </label>
                                <select
                                    id="type1"
                                    className="w-100 form-select"
                            ...
                            <div className="col-md-2 mt-4 mt-md-0 pe-sm-0">
                                <label htmlFor="number1" className="form-label">
                                    Número <span style={{ color: "red", fontWeight: "bolder" }}>*</span>
                                </label>
                                <input
                                    type="number"
                                    name="numero1"
                            ...
                            <div className="col-md-2 mt-4 mt-md-0 pe-sm-0">
                                <label htmlFor="letter1" className="form-label">
                                    Letra
                                </label>
                                <select
                                    id="letter1"
                        ...
                        <div className="d-md-flex justify-content-between mt-5">
                            ...
                            <div className="col-md-2 mt-4 mt-md-0">
                                <label htmlFor="letter2" className="form-label">
                                    Letra
                                </label>
                                <select
                                    id="letter2"
                            ...
                            <div className="col-md-2 mt-4 mt-md-0">
                                <label htmlFor="orientation2" className="form-label">
                                    Orientación
                                </label>
                                <select
                                    id="orientation2"
                            ...
                            <div className="col-md-2 mt-4 mt-md-0">
                                <label htmlFor="indicativo" className="form-label">
                                    Indicativo <span style={{ color: "red", fontWeight: "bolder" }}>*</span>
                                </label>
                                <input
                                    type="number"
                                    name="indicativo"
